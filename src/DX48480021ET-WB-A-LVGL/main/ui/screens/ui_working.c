...
int HF_number=15;//Initially
// Timer callback function used to update the progress bar value 
...
{  
    if(HF_ui_screen_id==3||HF_open==1)
    {
        ...
        // Increment the progress bar value with each call (adjust increment as needed)  
