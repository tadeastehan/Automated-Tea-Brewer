...
const ui_theme_variable_t _ui_theme_color_background[1] = {0xECE2CE};
const ui_theme_variable_t _ui_theme_alpha_background[1] = {255};

const ui_theme_variable_t _ui_theme_color_teacolor[1] = {0x92A202};
const ui_theme_variable_t _ui_theme_alpha_teacolor[1] = {255};
